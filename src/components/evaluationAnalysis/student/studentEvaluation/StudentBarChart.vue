...
<template>
  <div style="background-color: #caf0f8;" b-rounded-2 mt-2 mb-2 h-140>
    <h4 style="background-color: #90e0ef; color: white;" font-bold p-3 content-center text-lg text-gray-500>评语统计柱状图</h4>
